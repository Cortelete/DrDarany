      ...
      <div className="container mx-auto px-6">
        ...
        <AnimatedSection className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center mb-20">
          <div className="md:col-span-3 order-2 md:order-1">
            <h2 className="text-2xl md:text-3xl font-serif text-brand-text-dark dark:text-brand-text-light mb-6 uppercase tracking-wide">Dr. Darany Luiz Alves de Oliveira</h2>
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-xl font-bold font-serif text-brand-text-dark dark:text-brand-text-light mb-2 uppercase tracking-wide transition-colors duration-300 hover:text-brand-gold text-gold-glow-hover cursor-default">Da Caserna ao Tribunal</h3>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  <h3 className="text-xl font-bold font-serif text-brand-text-dark dark:text-brand-text-light mb-2 uppercase tracking-wide transition-colors duration-300 hover:text-brand-gold text-gold-glow-hover cursor-default">Defesa Estratégica</h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <AnimatedSection className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div key={index} className="bg-brand-light-gray dark:bg-brand-gray p-8 rounded-lg shadow-md border-b-4 border-brand-gold">
                    <h3 className="text-xl md:text-2xl font-serif text-brand-gold mb-3 uppercase tracking-wide">{item.title}</h3>
